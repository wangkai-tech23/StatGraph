...
def load_edges(path='../../Dataset50_40/train/edges/0/', adjes=[], tag='train'):
    tag = path[19:-9]
...
def load_nodes(path='../../Dataset50_40/train_nodes.csv'):
    print('Loading {} dataset of Novel nodes...'.format(path[17:-4]))
...
edge_path = '../../Dataset50_40/train/edges/'
train_adjes = []
for j in range(5):
    train_adjes = load_edges(path=edge_path + str(j) + '/', adjes=train_adjes)
print('length of train_adjes', len(train_adjes))  # length of train_adjes

# ''' Load edges data of val'''
edge_path = '../../Dataset50_40/val/edges/'
val_adjes = []
for j in range(5):
    val_adjes = load_edges(path=edge_path + str(j) + '/', adjes=val_adjes)
print('length of val_adjes', len(val_adjes))


# ''' Load Novel nodes data of train'''
train_batches = load_nodes(path="../../Dataset50_40/train_nodes.csv")
print('length of train_batches', len(train_batches))

# ''' Load Novel nodes data of val'''
val_batches = load_nodes(path="../../Dataset50_40/val_nodes.csv")
print('length of val_batches', len(val_batches))
